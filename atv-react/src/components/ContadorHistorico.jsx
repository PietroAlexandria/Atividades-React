...
export default function ContadorHistorico({contador}) {
    ...
    return (
        <div>
            ...
            <button className="counter" onClick={handleIncrementar} style={{marginTop: '10px'}}>Incrementar</button>
            <button className="counter" onClick={handleDecrementar} style={{ marginLeft: '10px' }}>Decrementar</button>
